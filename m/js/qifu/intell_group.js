	...
	$.ajax({
		...
		success: function (data) {
			...
			if(data.retcode==0000||data.retcode=="0000"){
                ...
                window.location.href="../../intelligence/group/index"+groupCode.substring(5,6)+".html?ZN_groupCode="+groupCode+"&groupMoney="+changeSelect_money(socreList.ansC)+"&answer="+answer;
			}else{
