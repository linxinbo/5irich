...
function gogroupbuynext() {
	window.location.href = "/m/group_buy/group_buy.html?tano=" + tano + "&comfundlist=" + comfundlist + "&buyflag=" + buyflag + "&groupId=" + groupId +"&groupname="+groupname+"&comratelist="+comratelist;
}
