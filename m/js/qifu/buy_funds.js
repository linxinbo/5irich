...
function Simulation(fundid) {
	window.location.href = "../simulation_of_books/k_books_rsg.html?fundid="+fundid;
}
//购买下一页
function gobuynext() {
	window.location.href = "../buy/buyfund.html?tano=" + tano + "&sharetype=" + sharetype + "&buyflag=" + buyflag + "&fundname=" + fundnamea + "&fundid=" + fundida + "&businesscode=" + businesscode + "&first_per_min_20=" + first_per_min_20 + "&first_per_max_20=" + first_per_max_20;
}
