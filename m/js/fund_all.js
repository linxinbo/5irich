$(function () {
	if (isUrl("fund_index.html")) { //全功能基金首页
		//搜索框
		$(".searchIcon").click(function () {
			if ($(".search_box").is(":hidden")) {
				$(".search_box").show(300);
				$(".iscroll_wrapper").animate({
					"top": 122
				});
			} else {
				$(".search_box").hide(300);
	...
	} else if (isUrl("fund_collect.html")) { //已收藏基金
		//是否继续显示“加载更多”
		var hasMoreData = true;
		setPullLoad(45, function (setScroll) {
			alert("调用Ajax");
			//删除上拉加载更多
			//$(".pullup").remove();
			var li = '<ul class="normal2_list"><li><div class="blue_vline"></div><div class="fund_name"><span>户一号&nbsp;&nbsp;87776&nbsp;</span><span class="collectIcon_solid"></span><em class="fr redColor1">发行</em></div></li><li><a href="#" class="w100"><table class="allFund_tab" border="0" width="93%" align=""><tr><td width="22%">最新净值：</td><td width="24%"><span class="brownColor1">1.2433</span></td><td width="22%" align="left">日涨幅：</td><td width="24%"><span class="grayColor1">0.1562%</span></td> <td rowspan="2" align="center"><span class="right_arrow"></span></td></tr><tr><td>累计三月：</td><td><span class="redColor1">1.2433%</span></td><td>累计一年：</td><td><center>-</center></td></tr></table> </a></li></ul>';
			$(li).insertBefore(".pullup");
			//重新初始化列表，防止无法上拉查看新加载数据
			setScroll();
			//在这里做判断，如果当前是最后一页，就关闭“加载更多”
			hasMoreData = false;
			if (!hasMoreData) {
				$(".pullup").hide();
				return;
		...
		$(".kmap_date td span").click(function () {
			...
			if (_index == 0) {
				myData = {
					x: ["01-02", "01-03", "01-04", "01-05", "01-06", "01-07", "01-08", "01-08", "01-08", "01-08", "01-08", "01-08", "01-08", "01-08", "01-08", "01-08", "01-08", "01-08", "01-08", "01-08", "01-08", "01-08", "01-08", "01-08", "01-08", "01-08"],
					y: [1.1, 1.9, 5.3, 2.6, 1.1, 3.0, 4.8, 4.8, 4.8, 4.8, 4.8, 4.8, 4.8, 4.8, 4.8, 4.8, 4.8, 4.8, 4.8, 4.8, 4.8, 4.8, 4.8, 4.8, 4.8]
				};
			} else if (_index == 1) {
				myData = {
					x: ["01-02", "01-03", "01-04", "01-05", "01-06", "01-07", "01-08"],
					y: [11, 9, 0, 26, 11, 30, 48]
				};
			} else if (_index == 2) {
				myData = {
					x: ["02", "03", "04", "05", "06", "07", "08"],
					y: [1.1, 1.9, 5.3, 26, 11, 3.0, 4.8]
				};
			}
			setChartJS(myData);
		});
