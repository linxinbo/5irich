					...
					if (response.retcode == "0000") {
						...
						for ( var i = 0; i < result.length; i++) {
							...
							if (result[i].tradeType == "1") {
								strHtml += "<a class='t_edit' href='k_books_rsg.html?id="
										+ result[i].id
										+ "&tradetype="
										+ result[i].tradeType + "'>修改</a>";
							} else if (result[i].tradeType == "5"
									|| result[i].tradeType == "6") {
								strHtml += "";
							} else if (result[i].tradeType == "2") {
								strHtml += "<a class='t_edit' href='k_books_jjsh.html?id="
										+ result[i].id
										+ "&tradetype="
										+ result[i].tradeType + "'>修改</a>";
							} else {
...
function gojymx() {
	window.location.href = mainUrl + "m/simulation_of_books/k_books_jymx.html";
}
