				...
				success : function(response) {
					if (response.retcode == "0000") {
						...
						for ( var i = 0; i < result.length; i++) {
							...
							strHtml += "</li>";
							strHtml += "<li><span>持有份额</span><span>"
							...
							strHtml += "</li>";
							strHtml += "<li><span>盈亏金额</span><span>"
					...
					if (response2.retcode == "0000") {
						...
						for ( var j = 0; j < result2.length; j++) {
							...
							strHtml2 += "<li><span>类型</span><span>" + fundType
									+ "</span>";
							strHtml2 += "</li>";
							strHtml2 += "<li><span>每万份收益</span><span>"
									+ perMillionCopiesOfIncome.toFixed(4)
									+ "</span>";
							strHtml2 += "</li>";
							strHtml2 += "<li><span>年化收益率</span><span>"
									+ sevenDaysOfAnnualYield.toFixed(4)
									+ "%</span>";
							strHtml2 += "</li>";
							strHtml2 += "<li><span>申购</span><span>" + buyOpen
									+ "</span>";
							strHtml2 += "</li>";
							strHtml2 += "<li><span>赎回</span><span>"
									+ fxedInvestmentOpen + "</span>";
							strHtml2 += "</li>";
