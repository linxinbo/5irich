                ...
                if (data.retcode == 0000) {
                    ...
                    if (data.data.isopen == 1) {
                        ...
                        if (newurl == "" || newurl == null) {
                            window.location.href = "account/login_right.html?isopen=" + data.data.isopen + "";
                        } else{
                            if (isLastUrl("change_right.html") || isLastUrl("sigin-right.html") || isLastUrl("sigin-right-open.html") || isLastUrl("account_right.html") || isLastUrl("forget_right.html") || isLastUrl("sigin.html")) {
...
//								window.history.go(-1);
                        ...
                        if(isLastUrl("k_books_rsg.html") || isLastUrl("k_books_home.html")){
                            ...
                            window.location.href = "account/login-right-open.html?isopen=" + data.data.isopen + "";
                        }
                    }
