...
//组合代码
var ZN_groupCode = args.ZN_groupCode;
var groupMoney = args.groupMoney;
var answer=args.answer;

$(document).ready(function () {
	$("#money_span").html(groupMoney);
});

function intelligence_buy(){
	groupBuyStep1(ZN_groupCode, "智能组合");
}
...
function gogroupbuynext() {
	window.location.href = "../group_buy/group_buy.html?tano=" + tano + "&comfundlist=" + comfundlist + "&buyflag=" + buyflag + "&groupId=" + groupId +"&groupname="+groupname+"&comratelist="+comratelist+"&groupMoney="+groupMoney;
}

function goto_back(){
	window.location.href="group_qustList.html?answer="+answer;
}
