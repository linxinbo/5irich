				...
				success : function(response2) {
					...
					if (response2.retcode == "0000") {
						...
						for ( var j = 0; j < result2.length; j++) {
							...
							strHtml2 += '<li class="l30 "><span>每万份收益</span><i class="font_lanse">'+ perMillionCopiesOfIncome.toFixed(4)	+ '</i></li>';
							strHtml2 += '<li class="l30 "><span>年化收益率</span><i class="font_lanse">'+ sevenDaysOfAnnualYield.toFixed(4)+'%</i></li>';
							strHtml2 += '<li class="l30 "><span>申购</span><i class="font_lanse">' + buyOpen	+ '</i></li>';
							strHtml2 += '<li class="l30 "><span>赎回</span><i class="font_lanse">'+ fxedInvestmentOpen +'</i></li>';
							strHtml2 += '<li class="l30 "><span>定投</span><i class="font_lanse">'+ redemptionOpen + '</i></li>';
							strHtml2 += '</ul>';
							strHtml2 += '</div>';
							// console.log(freeratioType);
							// var deleteMsg="您确定要删除吗？"
