		...
		success : function(response) {
			...
			$.ajax({
				...
				success : function(response1) {
					...
					//改变盈亏颜色 绿色 亏  红 盈利
					if (kfs_yk > 0) {
						$("#kfs_yk").removeClass("font_lv").addClass("font_hongse");
						$("#kfs_ykl").removeClass("font_lv").addClass("font_hongse");
						//$("#kfs_sz").removeClass("dq_lv").addClass("dq_hon");
					} else {
						$("#kfs_yk").removeClass("font_hongse").addClass("font_lv");
						$("#kfs_ykl").removeClass("font_hongse").addClass("font_lv");
			...
			$.ajax({
				...
				success : function(response2) {
					...
					//改变盈亏颜色 绿色 亏  红 盈利
					if (hb_yk > 0) {
						$("#hb_yk").removeClass("font_lv").addClass("font_hongse");
						$("#hb_ykl").removeClass("font_lv").addClass("font_hongse");
						//$("#hb_sz").removeClass("dq_lv").addClass("dq_hon");
					} else {
						$("#hb_yk").removeClass("font_hongse").addClass("font_lv");
						$("#hb_ykl").removeClass("font_hongse").addClass("font_lv");
			...
			$.ajax({
				...
				success : function(response3) {
					...
					//改变盈亏颜色 绿色 亏  红 盈利
					if (dt_yk > 0) {
						$("#dt_yk").removeClass("font_lv").addClass("font_hongse");
						$("#dt_ykl").removeClass("font_lv").addClass("font_hongse");
						//$("#dt_sz").removeClass("dq_lv").addClass("dq_hon");
					} else {
						$("#dt_yk").removeClass("font_hongse").addClass("font_lv");
						$("#dt_ykl").removeClass("font_hongse").addClass("font_lv");
