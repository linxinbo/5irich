        ...
        success: function (data) {
            ...
            if (data.retcode == "0000") {
                $(data.data.list).each(function (i, m) {
                    ...
                    applydata += "<li class='bottomline'><h2 class='jijinlist_table_t' data-id='"+m.fundcode+"' data-name='"+fundname+"'><em>"+fundname1+"</em><i>（"+fundid+"）</i></h2><a href='#' class='jy_riqi'><span class='t_span'>业务名称："+name+"</span></a></li>";
