        ...
        success: function (data) {
            ...
            if (data.retcode == 0000) {
                ...
                $(data.data).each(function(i,n){
                    ...
                    applydata += "<li class='bottomline'><h2 class='jijinlist_table_t' data-id='"+n.fundcode+"' data-name='"+n.fundname+"'><em>"+fundname1+"</em><i>（"+fundid+"）</i></h2><a href='#' class='jy_riqi'><span class='t_span'>下单时间："+n.opertime+"</span></a></li>";
