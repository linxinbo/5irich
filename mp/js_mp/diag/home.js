                    ...
                    success: function (data) {
                        ...
                        if (data.retcode == 0000) {
                            ...
                            $(data.data).each(function(i,n){
                                var pie_right = '<div class="zngroup_list"><div class="zngroup_list_left"><i class="zngroup_box bgcolor'+i+'"></i></div><div class="zngroup_list_right"><h2 style="color: #ee524f">'+n.fdProportional+'%</h2><span>组合占比</span></div><div class="zngroup_list_center"><h2 class="fontb'+i+'">'+ n.fundName +'</h2><span>基金代码：'+n.fundId.substring(0,6)+'</span></div>';
