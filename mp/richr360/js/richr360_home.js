	...
	$.ajax({
		...
		success: function (data) {
			...
			$(data.data).each(function (i, n) {
				...
				var font_yanse="font_hongse"
				console.log(fdReturnYearRatio);
				if(fdReturnYearRatio>0){
					var font_yanse="font_hongse"

				}else if(fdReturnYearRatio<0){
					var font_yanse="font_lv"
				}else {
					var font_yanse="font_huise"
				}
				...
				var gm_list_data = '<li>'+'<div class="zuhe_left">'+'<h2 profit="'+ profit +'" class="'+font_yanse+'">'+ fdReturnYearRatio1 +'</h2>'+'<p>近一年涨幅</p></div><div class="zuhe_right"><a class="go_buy" data-id="'+fundid+'" data-name="' + fundName + '"><span>立即购买</span></a></div><div class="zuhe_center"><h2>'+ fundName +'</h2><div style="margin-top:5px;"><a id="labelid" class="zh_btn_lan '+classNamelabel+'">长期稳健</a><a class="'+className5+'" style="margin-left:5px;">'+classNamecn+'</a></div></div></li>';
	...
	$.ajax({
		...
		success: function (data1) {
			...
			$(data1.data).each(function (i, n) {
				...
				var gm_list_data1 = '<li>'+'<div class="zuhe_left">'+'<h2 class="'+font_yanse+'">'+ fAvgreturnYear.toFixed(2)+'%</h2>'+'<p>近一年涨幅</p></div><div class="zuhe_right"><a class="go_buy" data-id="' + fundId + '" data-name="' + fundname + '" data-type="'+ fundTypeGoods +'"><span>立即购买</span></a></div><div class="zuhe_center"><h2>'+ fundname +'</h2><div style="margin-top:5px;"><a class="zh_btn_lan">混合型</a><a class="'+className+'"  style="margin-left:5px;">'+fundPersional+'</a></div></div></li>';
