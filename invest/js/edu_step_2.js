            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data.retcode == 0000 || data.retcode == "0000") {
                        //kaiguan=false;
                        $(".timeinvestfund").attr('disabled',"true");
                        saveScene("B",destName,money,scene_scheme,bank_name,data.data.appsheetserialno,data.data.buyplanno,fundcode,fundname);
    ...
    function saveScene(scene_no,scene_name,scene_money,scene_scheme,debit_account,appsheetserialno,buyplanno,fundcode,fundname){
        $.ajax({
            ...
            success: function (data) {
                if (data.retcode == 0000 || data.retcode == "0000") {
                    console.log("保存计划成功");
                    window.location.href = "travel_success.html?cycle=" + cycle;
                } else {
