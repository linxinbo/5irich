...
$(function(){
    ...
    if(username == "" || username == null || username == undefined|| username == "null") {
        ...
        $(".btn_next_travel").click(function(){
            ...
            window.location.href = "edu_step_2.html?destName=" + destName + "&fundcode=" + fundcode + "&fundname="+fundname+"&money="+money+"&cycle="+cycle+"&chanilid="+chanilid+"&moneyaccount="+moneyaccount+"&bank_name="+bank_name+"&tano="+tano+"&risklevel="+risklevel;
