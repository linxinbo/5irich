...
$(function(){
    ...
    if(username == "" || username == null || username == undefined|| username == "null") {
        ...
        var destName = "购房置业储备金";

        //插入旅行计划名称和人数
        $(".travel_dest").html(destName);
        //插入计划总金额
        ...
        $(".btn_next_travel").click(function(){
            ...
            window.location.href = "house_step_2.html?destName=" + destName + "&fundcode=" + fundcode + "&fundname="+fundname+"&money="+money+"&cycle="+cycle+"&chanilid="+chanilid+"&moneyaccount="+moneyaccount+"&bank_name="+bank_name+"&tano="+tano+"&risklevel="+risklevel;
