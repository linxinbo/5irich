    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if (data.retcode == 0000) {
                ...
                window.location.href = mainUrl+"mp/take_back/newback.html?fundid=" + fundid + "&fundname="+fundname+"&sharetype=" + sharetype + "&tano=" + tano + "&branchcode=" + branchcode + "&transactionaccountid=" + transactionaccountid + "&availbal=" + availbal + "&hold_min=" + hold_min + "&balfund=" + balfund + "&per_max_24=" + per_max_24 + "&per_min_24=" + per_min_24;
            } else {
