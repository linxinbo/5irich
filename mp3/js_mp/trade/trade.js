        ...
        success: function (data) {
            ...
            if (data.retcode == "0000") {
                ...
                $(data.data.list).each(function (i, n) {
                    ...
                    applydata += "<li class='bottomline'><h2 class='jijinlist_table_t' data-id='"+n.fundcode+"' data-name='"+fundname+"'><em>"+fundname+"</em><i>（"+fundid+"）</i></h2><a href='#' class='jy_riqi'><span class='t_span'>申请日期："+n.operdate+"</span></a></li>";
                    ...
                    applydata += "<li class='col-xs-4 col-sm-4 textcenter'><a><button class='btn_home1 jy_btn_lanse'>"+statsname+"</button><span class='xxiaotitle font_huise jy_span_mtop'>处理状态</span><b class='xxiaotitle font_huise'>时间："+n.operdate+"</b></a></li>";
                    applydata += "</ul></div></ul>";
