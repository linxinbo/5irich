...
function gobuynext(chouj) {
	window.location.href = mainUrl+"/mp/buynew/buynewfund_xjb.html?tano=" + tano + "&sharetype=" + sharetype + "&buyflag=" + buyflag + "&fundname=" + fundnamea + "&fundid=" + fundida + "&first_per_min_22=" + first_per_min_22 + "&first_per_max_22=" + first_per_max_22+"&status=" + status+"&chouj=" + chouj;
}
