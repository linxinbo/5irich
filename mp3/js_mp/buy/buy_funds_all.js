...
//购买第一步，风险测试；
function buyStep1(fundid, fundname,chouj) {
	fundida = fundid;
	fundnamea = fundname;
	console.log($(this));
	showLoading();
...
function gobuynext(chouj) {
	window.location.href = "/mp/buy/buyfund.html?tano=" + tano + "&sharetype=" + sharetype + "&buyflag=" + buyflag + "&fundname=" + fundnamea + "&fundid=" + fundida + "&businesscode=" + businesscode + "&first_per_min_20=" + first_per_min_20 + "&first_per_max_20=" + first_per_max_20+ "&chouj=" + chouj;
}
