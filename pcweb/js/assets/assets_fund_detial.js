...
$(function(){
    ...
    $(".position_fund_title a").html(newfundname);//基金名称
    $(".position_fund_title span").html(nfcode1);//基金代码
    if (username == "" || username == null || username == undefined|| username == "null") {
        ...
        //追加
        $(".fund_buy").off("click").on("click",function(){
            buyNewStep1(nfcode1,fundname);
        });
        //赎回
        $(".fund_redeem").off("click").on("click",function(){
            newRedeemStep1(nfcode1, fundname,transactionaccountid);
        });
        //定投
        ...
        //转换
        $(".fund_convert").off("click").on("click",function(){
            convertStep1(transactionaccountid,nfcode1);
        });

        //修改分红
        $(".fund_modify").off("click").on("click",function(){
            bonusfundStep1(nfcode1,transactionaccountid);
        });
