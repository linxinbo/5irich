			...
			success: function (data) {
				...
				if (data.retcode == 0000) {
					...
					if(data && data.data && data.data.risklevel == '1012'){
						...
						window.location.href = mainUrl+"trade/timeinvest.html?fundcode=" + fundcode + "&fundname="+fundname+"&sharetype=" +sharetype+ "&tano=" + tano + "&per_max_39=" + per_max_39 + "&per_min_39=" + per_min_39 + "&risklevel=" + risklevel + "";
					}
