        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (data.retcode == 0000 || data.retcode == "0000") {
                    kaiguan=false;
                    $(".buynewfund").attr('disabled',"true");
                    window.location.href = "purchase_cash_right.html?fundname=" + fundName + "&fundcode=" + fundcode + "&amount=" + userinfo1.money + "";
                } else {
                    ...
                    if(data.retcode == '-409999999'){
                        ...
                        window.location.href = "purchase_cash_error.html";
                        $(".buynewfund").removeAttr("disabled");
                        kaiguan=true;
                    }else{
